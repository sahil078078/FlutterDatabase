...
import 'pages/transaction_dialog.dart';
...
class _TransactionPageState extends State<TransactionPage> {
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        body: ValueListenableBuilder<Box<MyTransaction>>(
          valueListenable: Boxes.getTransactions().listenable(),
          builder: (context, box, _) {
            final transactions = box.values.toList().cast<MyTransaction>();
  ...
  Widget buildContent(List<MyTransaction> transactions) {
  ...
  Widget buildButtons(BuildContext context, MyTransaction transaction) => Row(
        children: [
          Expanded(
